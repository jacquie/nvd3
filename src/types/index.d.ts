...
declare namespace nv {
    ...
    interface GoalChart extends MultiChart {
        goalLine(func: (d: any) => number): this;
        systemTargetLine(func: (d: any) => number): this;
    }
    interface ControlChart extends MultiChart {
        controlLines(func: (d: any) => any[]): this;
    }
